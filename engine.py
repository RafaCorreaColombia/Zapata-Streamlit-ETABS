...
def generar_planta_zapata(L, B, info_nodos, s1, Cx_real, Cy_real, xr, yr, nube_puntos=None):
    ...
    ax.scatter([Cx_real], [0], color='blue', marker='x', s=90, alpha=0.6, label='Centro Geométrico (Cx)', zorder=5)
    # Resultante de Cargas (O verde)
    ax.scatter([xr], [yr], color='green', marker='o', s=90, alpha=0.6, edgecolors='white', label='Resultante Maestra', zorder=5)
